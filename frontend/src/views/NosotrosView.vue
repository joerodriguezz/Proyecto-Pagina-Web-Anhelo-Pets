...
<template>
  ...
  <section class="hero">
    ...
    <div class="hero-content">
      ...
      <h1>
        Una historia nacida
        del amor por rescatar
      </h1>

      <p>
        Personas, hogares y segundas oportunidades
        que cambiaron cientos de vidas.
      </p>
...
.gallery-track {
  ...
  animation:
    scrollGallery 65s linear infinite;
}
...
.gallery-item {
  ...
  box-shadow:
    0 14px 35px rgba(58,71,60,0.08);
}
